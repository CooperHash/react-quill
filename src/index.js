...
var ReactQuill = /** @class */ (function (_super) {
    ...
    */
    ...
    ReactQuill.prototype.render = function () {
        var _a;
        return (<div id={this.props.id} style={this.props.style} key={this.state.generation} className={"quill " + ((_a = this.props.className) !== null && _a !== void 0 ? _a : '')} onKeyPress={this.props.onKeyPress} onKeyDown={this.props.onKeyDown} onKeyUp={this.props.onKeyUp}>
